package janmokry.kaloricketabulkylite.core.network.calladapter
...
/**
 * source: https://github.com/yujinyan/retrofit-suspend-result-adapter/blob/master/src/main/kotlin/me/yujinyan/retrofit/SuspendResultCallAdapterFactory.kt
 */
